...
# We are running the script from .../microzed/zynqPL folder.
set top_folder "."

create_project zynqPL $top_folder -part xc7z010clg400-1
...
make_wrapper -files [get_files $top_folder/zynqPL.srcs/sources_1/bd/design_zynq/design_zynq.bd] -top

add_files -norecurse $top_folder/zynqPL.srcs/sources_1/bd/design_zynq/hdl/design_zynq_wrapper.v
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
launch_runs impl_1 -to_step write_bitstream -jobs 8


file mkdir $top_folder/zynqPL.sdk
file copy -force $top_folder/zynqPL.runs/impl_1/design_zynq_wrapper.sysdef /home/rnicolet/workspace/microzed/zynqPL/zynqPL.sdk/design_zynq_wrapper.hdf
